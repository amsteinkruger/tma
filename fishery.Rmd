...
# Vector for proportional natural mortalities at age. NB: marginal survival, not mortality. From INAPESCA (2018) / Cisneros-Mata et al. (1995).
fun_a_mort = function(n, m){s = n * exp(-m)}

```

#####c. Poaching Mortalities at Age
