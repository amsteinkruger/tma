...
v_select_data = 
  c(6, 9, 15, 60, 191, 281, 165, 133, 82, 33, 27, 21, 17, 10, 12, 16, 8, 15, 9, 12, 7, 9, 5, 2, 2, 0) %>% # All years.
...
* Next steps for 2/16:
+ finish selectivity/catchability estimation in section (c) above
+ estimate a back-of-the-envelope stiffness parameter
+ incorporate loose parameters into the full set
...
# NB: This is still far from working - refer to the mock-up above for the basic nested loop structure. That one does work.
                   ...
                   b[1, 2] = (n[1, 2] - n[1, 2] * m[1, 2]) * par[16] # Bycatch mortality for the single cohort actually affected.
                   
                   p[1] = 100 # Price for first year. 100 is absolutely arbitrary - just spinning things up.
                   
                   e[1] = 120 # Effort in boats/season for 2017 (INAPESCA 2018). Get this into par.                  
                   
                   y[1,] = n[1,] * 0.1 # Catch for first year by cohort. Arbitrary for spin-up.
                   ...
                   for(i in 2:par[1]){
                     ...
                     # Numbers for time i and the first cohort are recruitment for all 
                     n[i, 1] = rec[i - 1]
                     
                     # Natural mortalities for time i and the first cohort.
                     ...
                     for(j in 2:par[2]){
                     y[i, j] = (n[i, j] - m[i, j] - b[i, j]) * 0.0001 * e[i] * fun_poach(a[i, j]) # Identify selectivity and catchability to get this right.
                     y[i, 1] = 0
                     }
                     ...
                     c[i] = e[i] * 5 # Get an actual cost into par.
                     
                   }
                   # Get results.
                   return(list("n" = n, "y" = y, "m" = m, "b" = b))
                   }
