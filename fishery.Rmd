...
v_mort_rest = rep(0.73, 29)

# Vector for proportional poaching mortalities at age.

# Vector for proportional bycatch mortalities at age.
...
# Set up first test.
fun_test = function(nrow, ncol, ninit, mort_rate, mort_cols, v_eggs, k){
                                mat_a = matrix(nrow = nrow, ncol = ncol)
...
# Run first test.
uh = fun_test(25, 30, ninit, 0.73, 29, v_eggs, 5000000)
...
ggplot(melt, aes(x = variable, z = value, y = t, color = variable)) + 
  theme_void() + 
  #axes_3D() + 
  stat_3D(geom = "line", phi = 5, theta = 90) +
  #labs_3D() +
