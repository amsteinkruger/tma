...
# Set up the whole thing. Template.
...
# NB: This is still far from working - refer to the mock-up above for the basic nested loop structure. That one does work.
                   ...
                   a = as.numeric(vector(length = par[1]))  # Build a vector of ages for easier reference.
                   ...
                   e[1] = 100 # Effort for first year. 100 is absolutely arbitrary - just spinning things up.                   
