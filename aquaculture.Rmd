...
cost = ggplot(tibble_rc, aes(t, val)) +
      ...
      annotate("text", x = 8.5, y = 1.150000, label = "Costs", size = 9, family = "Century Gothic") +
      scale_x_continuous(limits = c(1, 10), breaks = c(1, 10), expand = c(0, 0.125)) +
...
meat = ggplot(tibble_rc, aes(t, val, color = var)) +
      ...
      scale_x_continuous(limits = c(1, 10), breaks = c(1, 3, 10),expand = c(0, 0.125)) +
      scale_y_continuous(limits = c(0, 3.000000), labels = scales::comma, expand = c(0, 0)) +
      btheme +
...
mbpi = ggplot(tibble_rc, aes(t, val, color = var)) +
      ...
      scale_color_manual(values = c("#F4B183", "#1F4E79")) +
      labs(x = "Years", y = "Millions USD", color = "") +
      scale_x_continuous(expand = c(0, 0.125), limits = c(1, 10), breaks = c(1, 10)) +
...
ggplot(data = slapdat) +
  ...
  scale_x_continuous(expand = c(0, 0.125), breaks = c(0, 5, 10, 14, 17), limits = c(0, 17)) +
...
aq11 = ggplot(tibble_rc, aes(t, val, color = var)) +
      ...
      labs(x = "Years", y = "Millions USD", color = "") +
      scale_x_continuous(expand = c(0, 0.125), limits = c(1, 10), breaks = c(1, 4, 8, 10)) +
