...
# Set function.
fn_am = function(a, b1, b2, b3){m = b1 * exp(b2 * a) + b3} 
...
n = density / w * (1 - 0.01 * fn_am(amlag, am_b1, am_b2, am_b3))
...
m_sale = integrate(fn_am, lower = 0, upper = a_sale, b1 = am_b1, b2 = am_b2, b3 = am_b3)

# Initial cohort count:
nsale + nsale * ((m_sale$value) * 0.01)
