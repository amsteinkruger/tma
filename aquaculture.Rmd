...
# Set parameters for reference.
f_b1 = 0.04 #fcr_reg_tidy$estimate[1]
...
cost = ggplot(tibble_rc, aes(t, val)) +
      ...
      annotate("text", x = 8.5, y = 4.35, label = "Costs", size = 9, family = "Century Gothic") +
      scale_x_continuous(limits = c(1, 10), breaks = c(1, 2, 10), expand = c(0, 0.125)) +
      scale_y_continuous(limits = c(0, 6.000000), labels = scales::comma, expand = c(0, 0)) +
      theme_classic() +
...
meat = ggplot(tibble_rc, aes(t, val, color = var)) +
      ...
      geom_path(size = 3) +
      annotate("text", x = 8.5, y = 4.35, label = "Costs", size = 9, family = "Century Gothic") +
      annotate("text", x = 9, y = 2.750000, label = "Revenues", size = 9, family = "Century Gothic") +
...
mbpi = ggplot(tibble_rc, aes(t, val, color = var)) +
      geom_path(size = 3) +
      annotate("text", x = 8.5, y = 6.25, label = "Costs", size = 9, family = "Century Gothic") +
