...
aq = function(par){t = as.numeric(vector(length = par[2]))  # First, initialize blank vectors for each variable.
                   ...
                   for(i in 2:par[2]){
                    ...
                    output = tibble(t, c, r, p0, w0, n0, h)

                  return(output)}

```

##### Run 00 (With Profit Calculation)
...
# Plot cumulative revenues and costs through harvest cycles.
aq00 = ggplot(tibble_rc, aes(t, val, color = var)) +
      geom_path() +
      labs(x = "Years", y = "USD2018") +
      #scale_x_continuous(expand = c(0, 0), limits = c(1, 25)) +
      #scale_y_continuous(expand = c(0, 0), limits = c(0, 300000000), labels = scales::comma) +
...
# Plot cumulative revenues and costs through harvest cycles.
aq01 = ggplot(tibble_rc, aes(t, val, color = var)) +
      geom_path() +
      labs(x = "Years", y = "USD2018") +
      #scale_x_continuous(expand = c(0, 0), limits = c(1, 25)) +
      #scale_y_continuous(expand = c(0, 0), limits = c(0, 300000000), labels = scales::comma) +
...
# Plot cumulative revenues and costs through harvest cycles.
aq10 = ggplot(tibble_rc, aes(t, val, color = var)) +
      geom_path() +
      labs(x = "Years", y = "USD2018") +
      #scale_x_continuous(expand = c(0, 0), limits = c(1, 25)) +
      #scale_y_continuous(expand = c(0, 0), limits = c(0, 300000000), labels = scales::comma) +
...
# Plot cumulative revenues and costs through harvest cycles.
aq11 = ggplot(tibble_rc, aes(t, val, color = var)) +
      geom_point() +
      labs(x = "Years", y = "USD2018") +
      #scale_x_continuous(expand = c(0, 0), limits = c(1, 25)) +
      #scale_y_continuous(expand = c(0, 0), limits = c(0, 300000000), labels = scales::comma) +
...
cost = ggplot(tibble_rc, aes(t, val)) +
      ...
      theme(plot.title = element_text(hjust = 0.5, size = 32, family = "Century Gothic", face = "bold"), 
          ...
          axis.text.x = element_text(size = 14, family = "Century Gothic"),
          axis.title.x = element_text(size = 24, family = "Century Gothic", face = "bold"),
          axis.text.y = element_text(size = 14, family = "Century Gothic"),
...
w_plot = ggplot(weights) +
      ...
      scale_x_continuous(limits = c(0, 27), breaks = c(0, 10, 20, 27)) +
      scale_y_continuous(limits = c(0, 150), labels = scales::comma) +
      theme_classic() +
      ggtitle("Totoaba Growth") +
      theme(plot.title = element_text(hjust = 0.5, size = 32, family = "Century Gothic", face = "bold"), 
          rect = element_rect(fill = "transparent"),
          plot.background = element_rect(fill = "transparent", color = NA),
          legend.position = "right",
...
meat = ggplot(tibble_rc, aes(t, val, color = var)) +
      ...
      labs(x = "Years", y = "USD (2018)", color = "") +
      scale_x_continuous(expand = c(0, 0), limits = c(1, 10), breaks = c(1, 3, 10)) +
      scale_y_continuous(expand = c(0, 0), limits = c(0, 3000000), labels = scales::comma) +
      theme_classic() +
      ggtitle("Costs and Revenues for One Cage - Meat Only") +
      theme(plot.title = element_text(hjust = 0.5, size = 32, family = "Century Gothic", face = "bold"), 
          rect = element_rect(fill = "transparent"),
          plot.background = element_rect(fill = "transparent", color = NA),
          legend.position = "right",
...
mbpi = ggplot(tibble_rc, aes(t, val, color = var)) +
      ...
      scale_color_manual(values = c("#F4B183", "#1F4E79")) +
      labs(x = "Years", y = "USD (2018)", color = "") +
      scale_x_continuous(expand = c(0, 0), limits = c(1, 10), breaks = c(1, 4, 10)) +
      scale_y_continuous(expand = c(0, 0), limits = c(0, 30000000), labels = scales::comma) +
      theme_classic() +
      ggtitle("Costs and Revenues for One Cage") +
      theme(plot.title = element_text(hjust = 0.5, size = 32, family = "Century Gothic", face = "bold"), 
          rect = element_rect(fill = "transparent"),
          plot.background = element_rect(fill = "transparent", color = NA),
          legend.position = "right",
...
ggplot(data = slapdat) +
  ...
  geom_segment(aes(x = 14, xend = 14, y = 0, yend = Inf), linetype = "dashed") +
  labs(x = "Tonnes of Dry Maw", y = "USD per Gram of Dry Maw") +
  scale_x_continuous(expand = c(0, 0), breaks = c(0, 5, 10, 14, 17), limits = c(0, 17)) +
...
aq11 = ggplot(tibble_rc, aes(t, val, color = var)) +
      ...
      geom_line(size = 3) +
      labs(x = "Years", y = "USD", color = "") +
      scale_x_continuous(expand = c(0, 0), limits = c(1, 10), breaks = c(1, 4, 8, 10)) +
      scale_y_continuous(expand = c(0, 0), limits = c(0, 17000000), labels = scales::comma) +
      ggtitle("Costs and Revenues for One Cage - Trimming and Harvest") +
      scale_color_manual(values = c("#F4B183", "#1F4E79")) +
      theme_classic() +
      theme(plot.title = element_text(hjust = 0.5, size = 32, family = "Century Gothic", face = "bold"), 
