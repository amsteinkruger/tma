...
#n = nstart - fn_nt(density, w, a, am_b1, am_b2, nstart) #* (1 - fn_am_marg(t, am_b1, am_b2)) # Fix mortality.
...
aq = function(par){t = as.numeric(vector(length = par[2]))
                   ...
                   for(i in 2:par[2]){
                     ...
                     c0[i] = fn_ch0(w0[i], par[16], par[17], par[18], n0[i], par[19]) + 10000 * w0[i] ^ 2
                     ...
                     c1[i] = fn_ch0(w1[i], par[16], par[17], par[18], n1[i], par[19]) + 10000 * w1[i] ^ 2
                     
                     # Mind wrapper for hard-coding lower bound age at harvest.
                     h[i] = ifelse(a0[i] > 2, ifelse((r0[i] - c0[i]) > (par[21] * (r1[i] - c1[i] + rt0[i])), 1, 0), 0)
                     hinv[i] = (h[i] - 1) ^ 2
